...
(async () => {
    ...
    if (!dataJson) {
        // Jika tidak ada data yang dikirim, keluar dengan error
        console.error("❌ Error: Tidak ada data JSON yang diterima dari Laravel.");
        process.exit(1); // Ini penting agar Laravel tahu prosesnya gagal
    }
        
    // Ubah teks JSON kembali menjadi objek JavaScript
    // const data = rows[0];
