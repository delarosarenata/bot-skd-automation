...
(async () => {
    ...
    try {
        ...
        console.log("Menunggu pop-up petunjuk...");
        const tombolSelanjutnya = page.locator('button[data-dismiss="modal"].btn-success');

        // Tunggu sampai tombol benar-benar terlihat dan bisa diklik
        await tombolSelanjutnya.waitFor({ state: 'visible' });

        // Baru setelah itu, klik tombolnya
